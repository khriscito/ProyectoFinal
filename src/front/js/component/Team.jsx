  ...
  return (
    <section className="page-section bg-light" id="team">
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-8 mx-auto text-center"><p className="large text-muted">Somos un equipo caracterizado por brindar sistemas accesibles que faciliten gestiones del día a día</p></div>
                </div>
            </div>
        </section>
  )
